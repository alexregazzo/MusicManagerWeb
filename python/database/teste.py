...
#
# from python.database.utils import get_database_schema, get_database_engine, get_transaction
#
...
#     tok_token_expires_at = Column('tok_token_expires_at', TIMESTAMP(timezone=True), nullable=False)
